...
var RxFirebaseAuth = (function () {
    ...
    RxFirebaseAuth.prototype.createCustomToken = function (uid, additionalClaims) {
        if (additionalClaims === void 0) { additionalClaims = {}; }
        return this._auth.createCustomToken(uid, additionalClaims);
    };
    RxFirebaseAuth.prototype.rx_verifyIdToken = function (idToken) {
        return Rx_1.Observable.fromPromise(this._auth.verifyIdToken(idToken));
    };
